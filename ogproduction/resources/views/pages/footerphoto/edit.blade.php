...
@section('content')
    <div class="box box-block bg-white clearfix">
        ...
        <form action="{{ route('footerphoto.update',$footerphotos->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="file" class="dropify" name="image" id="image" data-default-file="{{ asset($footerphotos->image_path)  }}">
            </div>
