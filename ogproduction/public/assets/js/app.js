$(document).ready(function(){
	...
	if(jQuery.browser.mobile == true) {
		$('.customs-scroll').css('overflow-y','scroll');
	}
	...
	$('.template-options input:radio').change(function() {
		...
		if(setting == 'skin-default' || setting == 'skin-2' || setting == 'skin-6') {
			$('.site-sidebar .customs-scroll').removeClass('custom-scroll-dark').addClass('custom-scroll-light');
			$('.site-sidebar .progress-widget').removeClass('progress-widget-dark').addClass('progress-widget-light');
		} else {
			$('.site-sidebar .customs-scroll').removeClass('custom-scroll-light').addClass('custom-scroll-dark');
