                ...
                <div class="row">
                    <div class="col-lg-8 personal-info">
                        ...
                        <div class="row">
                            <div class="col-lg-10">
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label form-control-label">Yelp Link</label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" name="yelp_link" value="{{isset($contact->yelp_link) ? $contact->yelp_link : ''}}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-10">
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label form-control-label">Google Link</label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" name="google_link" value="{{isset($contact->google_link) ? $contact->google_link : ''}}">
                                    </div>
                                </div>
                            </div>
                        </div>
