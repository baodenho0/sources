...
@section('content')
	...
	<section class="blog-banner-area" id="category">
		<div class=" h-100" style="background: url({{isset($banner->image) ? asset('upload/images').'/'.$banner->image :'' }}) right center no-repeat;">
            ...
            <ol class="breadcrumb">
              {{-- <li class="breadcrumb-item">Tất cả</li> --}}
      ...
      <div class="row">
          ...
          <div class="sidebar-categories">
            ...
            <ul class="main-categories">
              <li class="common-filter">
                <form action="#">
                  <ul>
                    <li class="filter-list"><input class="pixel-radio category" type="radio" data="" id="all" name="brand"><label for="all">ALL<span></span></label></li>
                    @foreach ($category as $element)
                    
                   <li class="filter-list"><input class="pixel-radio category" type="radio" data="{{$element->id}}" id="{{$element->name}}" name="brand"><label for="{{$element->name}}">{{$element->name}}<span></span></label></li>
        ...
        <div class="col-xl-9 col-lg-8 col-md-7">
          ...
          <section class="lattest-product-area pb-40 category-list">
            <div id="list-product">
              @include('guest.category.list_product')
            </div>
          </section>         
...
@section('scripts')
  ...
  <script>
    ...
    function fetchData(page){
        var category = $("input[name=brand]:checked").attr('data');
        $.ajax({
          url:"{{ route('fetchPagination') }}",
