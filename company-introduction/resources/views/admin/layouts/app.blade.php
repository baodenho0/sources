...
<html lang="en">
   <head>
      ...
      <link rel="stylesheet" href="vendor/loadingModal/jquery.loadingModal.css">
      <!-- datatable css -->      
      @yield('style')
   </head>
   <body id="page-top">      
...
{{-- <script src="js/bootstrap.min.js" ></script> --}}
      ...
      <script src="vendor/loadingModal/jquery.loadingModal.js"></script>
      <script src="vendor/loadingModal/run.js"></script>
