                ...
                <div class="row">
                    <div class="col-lg-8 personal-info">
                        ...
                        <div class="row">
                            <div class="col-lg-10">
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label form-control-label">Facebook Link</label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" name="facebook_link" value="{{isset($contact->facebook_link) ? $contact->facebook_link : ''}}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-10">
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label form-control-label">Youtube Link</label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" name="youtube_link" value="{{isset($contact->youtube_link) ? $contact->youtube_link : ''}}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-10">
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label form-control-label">Zalo Link</label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" name="zalo_link" value="{{isset($contact->zalo_link) ? $contact->zalo_link : ''}}">
                                    </div>
                                </div>
                            </div>
                        </div>
