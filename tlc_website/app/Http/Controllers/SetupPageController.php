...
class SetupPageController extends Controller
{
    ...
    public function postLogo(Request $request){
        ...
        $logo->range_begin = $request->range_begin;
        $logo->range_end = $request->range_end;
        $logo->register_count = $request->register_count;
        $logo->register_number = $request->register_number;
        $logo->register_password = $request->register_password;
