...
Route::group(['prefix' => 'admin','middleware' => ['auth']], function() {
    ...
    Route::get('/step','StepController@get');
    Route::post('/step','StepController@post');
    ...
    Route::group(['prefix' => 'country'], function() {
        ...
        Route::get('/edit','CountryController@getEdit')->name('country.edit');
        Route::post('/edit','CountryController@postEdit')->name('country.postEdit');
        Route::get('/add','CountryController@getAdd')->name('country.add');
        Route::post('/add','CountryController@postAdd');
        Route::get('/datatables','CountryController@datatable')->name('country.datatables');
        Route::post('/delete','CountryController@delete')->name('country.delete');
       
    });

    Route::group(['prefix' => 'step_description'], function() {
        Route::get('/','StepDescriptionController@index')->name('step_description');
        Route::get('/edit','StepDescriptionController@getEdit')->name('step_description.edit');
        Route::post('/edit','StepDescriptionController@postEdit')->name('step_description.postEdit');
        Route::get('/add','StepDescriptionController@getAdd')->name('step_description.add');
        Route::post('/add','StepDescriptionController@postAdd');
        Route::get('/datatables','StepDescriptionController@datatable')->name('step_description.datatables');
        Route::post('/delete','StepDescriptionController@delete')->name('step_description.delete');
    ...
    Route::group(['prefix' =>'about'], function() {
        Route::get('/edit','AboutController@getEdit')->name('about.edit');
        Route::post('/edit','AboutController@postEdit');
    });

    Route::group(['prefix' =>'bmln'], function() {
        Route::get('/edit','BMLNController@getEdit')->name('bmln.edit');
        Route::post('/edit','BMLNController@postEdit');
    });

    Route::group(['prefix' =>'doi-tac-chien-luoc'], function() {
        Route::get('/edit','DoiTacChienLuocController@getEdit')->name('dtcl.edit');
        Route::post('/edit','DoiTacChienLuocController@postEdit');
    });

    Route::group(['prefix' =>'nen-tang-giao-dich'], function() {
        Route::get('/edit','NenTangGiaoDichController@getEdit')->name('nen-tang-giao-dich.edit');
        Route::post('/edit','NenTangGiaoDichController@postEdit');
    });

    Route::group(['prefix' =>'hop-tac'], function() {
        Route::get('/edit','HopTacController@getEdit')->name('hop-tac.edit');
        Route::post('/edit','HopTacController@postEdit');
    });
    ...
    Route::group(['prefix' => 'contact-list'], function() {
        Route::get('/','ContactListController@index')->name('contactList');
        Route::get('/datatables','ContactListController@datatable')->name('contactList.datatable');
    });

    Route::group(['prefix' => 'register-list'], function() {
        Route::get('/','RegisterController@index')->name('registerList');
        Route::get('/datatables','RegisterController@datatable')->name('registerList.datatable');
    });

    Route::group(['prefix' => 'hop-tac-list'], function() {
        Route::get('/','HopTacController@index')->name('hoptacList');
        Route::get('/datatables','HopTacController@datatable')->name('hoptacList.datatable');
    });
    ...
    Route::group(['namespace' => 'Website'], function() {
        Route::get('lang-vi', 'LangController@vi')->name('lang.vi');
        Route::get('lang-en', 'LangController@en')->name('lang.en');
        Route::get('register','RegisterController@index')->name('website.register');
        Route::post('register','RegisterController@post')->name('website.register.post');
        ...
        Route::get('contactus','ContactController@index')->name('website.contact');
        Route::post('contactus','ContactController@post')->name('website.contact.post');
        Route::get('aboutus','AboutController@index')->name('website.about');
        Route::get('bmln','BMLNController@index')->name('website.bmln');
        Route::get('partnership','DoiTacChienLuocController@index')->name('website.partnership');
        Route::get('nen-tang-giao-dich','NenTangGiaoDichController@index')->name('website.nen-tang-giao-dich');
        Route::get('hop-tac','HopTacController@index')->name('website.hop-tac');
        Route::post('register-hop-tac','HopTacController@post')->name('website.hop-tac.post');
        ...
        Route::get('newsandevents', 'PostController@index')->name('newsandevents');
        Route::get('newsandevents/{slug}', 'PostController@detail')->name('newsandevents.detail');
